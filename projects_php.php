...
<head>
	...
	<link rel="canonical" href="http://www.codeworkshop.co.uk/index.php" />
...
<?php include("includes/_header_global.php"); ?>
		<p>The following 'non js' content rendered by <a href="modules/_project_list_seo.php.txt">php</a> from the same <a href="json/cws_en.json">json</a> as the <a href="index.php">js version</a>.</p>
		<hr>
		<div id="projects">
